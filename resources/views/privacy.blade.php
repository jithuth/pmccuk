...
@section('content')
    ...
    <section class="py-24 bg-white border-b border-slate-200 overflow-hidden relative">
        ...
        <div class="max-w-4xl mx-auto px-4 relative z-10">
            <span class="text-primary font-black uppercase tracking-[0.4em] text-xs mb-6 block italic">Legal
                Agreements</span>
    ...
    <section class="py-20 bg-slate-50">
        <div class="max-w-4xl mx-auto px-4">
            <div
                class="bg-white p-12 md:p-16 rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 prose prose-slate max-w-none">
